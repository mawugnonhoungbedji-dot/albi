...
export default function SolidarityCarousel({ onCardClick }: SolidarityCarouselProps) {
  ...
  const carouselItems: CarouselItem[] = [
    ...
    },
    {
      ...
      image: "/src/assets/images/albi_sun_cream_sage_1781884128743.jpg",
      category: "Histoire",
    ...
    },
    {
      ...
      image: "/src/assets/images/albi_children_school_1781884113577.jpg",
      category: "Éducation",
    ...
    },
    {
      ...
      image: "/src/assets/images/volunteers_park_1781879709971.jpg",
      category: "Avenir",
